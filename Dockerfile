...
RUN pip3 install Flask==2.1.2 Werkzeug==2.1.2 flask-sqlalchemy flask-login Flask-WTF email_validator flask_wtf flask-sitemap Flask-Mail flask-restx flask-marshmallow marshmallow-sqlalchemy markdown2 boto3 mkdocs waitress
